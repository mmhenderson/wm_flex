...
for ss=1:length(sublist)
    ...
    fn2save = fullfile(save_dir,sprintf('TrnLoc_TestWM_%s.mat',substr));
...
%             % rightmost point.
%             left_edge = trnLabsIEM(tt)-wedge_width_deg/2+0.5;
%             right_edge = trnLabsIEM(tt)+wedge_width_deg/2-0.5;
...
%         end
        ...
        %TODO - FIGURE OUT WHY THE BASELINE IS SHIFTED SO MUCH!!
%         chan_resp = chan_resp - repmat(mean(chan_resp,2),1,size(chan_resp,2));
