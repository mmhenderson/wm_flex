...
if plotVisMotorAcc
    ...
    plot_barsAndStars(meanvals,semvals,[],[],chance_val,acclims,vismotor_names,condLabStrs,'Accuracy','Classify Disk Sides (average of four 2-way)',col)
end
