%% Get average signal in each trial of main task.
% This is the main task with random and predictable responses.
...
for ss = sublist
    ...
    fn2load = fullfile(exp_path,'Samples',sprintf('SampleFile_IPSbig_%s.mat',substr));
    ...
    fn2save = fullfile(exp_path,'Samples',sprintf('MainTaskSignalByTrial_IPSbig_%s.mat',substr));    
