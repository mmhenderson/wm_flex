...
for ss=1:length(sublist)
    ...
    fn2load = fullfile(save_dir,sprintf('ClassifyResponse_TrnDigLoc_TRbyTR_%s_%dvox_%s.mat',class_str,nVox2Use,substr));
    load(fn2load);
...
saveas(gcf,fullfile(figpath,'DecodeCorrectResp_TrnDigLoc_allareas_overtime.pdf'),'pdf');
