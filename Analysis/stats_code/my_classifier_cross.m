function [acc,dprime,predLabs] = my_classifier_cross(trndat,trnlabs,trnruns,tstdat,tstlabs,tstruns,classstr,nBalanceIter,nVox2Keep,voxStatTable,resamp)
    ...
    if doBalance
        ...
        parfor bb=1:nBalanceIter
            ...
            switch classstr
                ...
                case 'eucDist'
                    [thesepredlabs,~] = eucDistClass(trnuse,tstdat_thisloop,trnlabsuse);
                case 'ideal_observer'
                    [thesepredlabs,~] = ideal_observer(trnuse,tstdat_thisloop,trnlabsuse);
                case 'normEucDist'
                    [thesepredlabs,~] = normEucDistClass(trnuse,tstdat_thisloop,trnlabsuse);
                otherwise
