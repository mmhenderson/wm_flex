%% Plot accuracy of boundary orientation decoding
...
% Makes Figure 2 - figure supplement 3
%%
clear
close all;
...
array2table([diff_is_sig(vismotor_inds), p_diff(vismotor_inds)],...
    'RowNames',vismotor_names,'VariableNames',{'cond_diff','p'})
