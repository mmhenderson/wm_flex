...
function visualize_DWM_ROIs(subj_FS,subnum,hemi,which_finger, which_atlas)
    % function to launch tksurfer and visualize the results of DWM
    % localizer (left versus right motor prep signals) on inflated 
    % cortical mesh.
    % Assumes that you ran GLM analysis in FSL FEAT, and the results are
    % saved in a folder called AnalyzeDWMLocalizer.
...
%         which_atlas='DKT';
    ...
    subinit_big = {'BX','BR','CI','CA','CH','AV'};
    subnum_big = {'S01','S02','S03','S04','S05','S06'};
    ...
    % copes 3 and 4 are l>r and r>l, for delay period of task
    ...
    loc_subfolder = 'AnalyzeDWMLocalizer';
