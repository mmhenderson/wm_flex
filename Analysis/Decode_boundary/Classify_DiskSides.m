%% Classifying the coloration of the two sides of the disk. 
% First, divide up the trials into bins based on the boundary orientation 
% (a 0-180 space).
...
for ss=1:length(sublist)
    ...
    fn2save = fullfile(save_dir,sprintf('ClassifyDiskSides_%s_%dvox_%s.mat',class_str,nVox2Use,substr));
    ...
    for vv = v2do
        ...
        for cc = 1:nConds
            ...
            for xx = 1:nGroups
                ...
                % use custom code to do cross-validation
