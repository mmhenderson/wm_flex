...
for ss=1:length(sublist)
    ...
    fn2load = fullfile(save_dir,sprintf('ClassifyResponseLum_%s_%dvox_%s.mat',class_str,nVox2Use,substr));
    load(fn2load);
...
if plotVisMotorAcc
    ...
    plot_barsAndStars(meanvals,semvals,[],[],chance_val,acclims,vismotor_names,condLabStrs,'Accuracy','Classify Response Luminance',col)
end
%% make a bar plot of dprime - visual areas
if plotVisMotorD
    ...
    plot_barsAndStars(meanvals,semvals,[],[],[],dprimelims,vismotor_names,condLabStrs,'Dprime','Classify Response Luminance',col)
end
...
if plotMD_Acc
    ...
    plot_barsAndStars(meanvals,semvals,[],[],chance_val,acclims,md_names,condLabStrs,'Accuracy','Classify Response Luminance',col)
end
...
if plotMD_D
    ...
    plot_barsAndStars(meanvals,semvals,[],[],[],dprimelims,md_names,condLabStrs,'Dprime','Classify Response Luminance',col)
end