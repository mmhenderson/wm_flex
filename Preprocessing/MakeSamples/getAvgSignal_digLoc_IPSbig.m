%% Get average signal in each trial of motor response task.
% This is the button pressing task used to localize sensorimotor ROIs.
...
for ss = sublist
    ...
    fn2save = fullfile(exp_path,'Samples',sprintf('DigLocSignalByTrial_IPSbig_%s.mat',substr));    
