...
% Decoding analysis itself performed in TrnSpatMap_TstWM.m and saved as mat
...
for ss=1:length(sublist)
    ...
    fn2load = fullfile(save_dir,sprintf('TrnSpatMap_TestWM_BigBins_%s_max%dvox_%s.mat',class_str,nVox2Use,substr));
    load(fn2load);
...
saveas(gcf,fullfile(figpath,'TrainSpatMap_TestWM_allareas.pdf'),'pdf');
