%% Get average signal in each trial of digit working memory task, keeping hemispheres separate.
% This is the button pressing delayed response task.
% This script generates a structure array [nROIs x 2] long, with each element
% containing a structure for one ROI and one hemisphere.
% Structure includes fields for the task data [nTrials x nVoxels] and 
% labels [nTrials x 1] for what was happening on each trial of the task. 
...
% x nVoxels] in size, for each ROI/hemisphere.
% Loads the file generated by MakeSampleFile

% Note this data isn't used in any of our main analyses. 
%%
clear
close all
...
avgTRs_stim = [3,7];
% also averaging over data after the response probe onset (this doesn't 
% get used for anything further)
avgTRs_resp = [4,7];
