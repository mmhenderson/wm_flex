%% Get average signal in each trial of spatial working memory mapping task.
% This is the spatial working memory task with continuous report. 
...
for ss = sublist
    ...
    fn2save = fullfile(exp_path,'Samples',sprintf('SWMLocSignalByTrial_IPSbig_%s.mat',substr));    
