...
if plotVisMotorD
    ...
    plot_barsAndStars(meanvals,semvals,[],[],[],dprimelims,vismotor_names,condLabStrs,'Dprime','Classify Boundary Preview Orientation',col)
end
...
if plotMD_D
    ...
    plot_barsAndStars(meanvals,semvals,[],[],[],dprimelims,md_names,condLabStrs,'Dprime','Classify Boundary Preview Orientation',col)
end