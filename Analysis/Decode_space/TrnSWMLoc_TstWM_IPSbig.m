...
for ss=1:length(sublist)
    ...
    fn2load = fullfile(exp_path,'Samples',sprintf('SWMLocSignalByTrial_IPSbig_%s.mat',substr));
    load(fn2load);
    ...
    fn2save = fullfile(save_dir,sprintf('TrnSWMLoc_TestWM_IPSbig_%s_max%dvox_%s.mat',class_str, nVox2Use,substr));
